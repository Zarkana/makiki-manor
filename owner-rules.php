...
<html lang="en">
<head>
  <title>Makiki Manor | Owner's Rules</title>  
  <?php
  ...
  <div id="wrapper">    
    <main id="content" class="accordian-content">
      ...
      try {
        ...
        $stmt->execute(array(':sectionID' => 8));
        $row = $stmt->fetch(); 
      ...
      <div class="section" id="owner-rules-about">
        <div id="owner-rules-about-paragraph" class="paragraph">
              ...
              while($file = $stmt->fetch()){
                ...
                <div>
                  <div class="content-doc">
                    <object data="files/documents/<?php echo($file["filename"]);?>" type="application/pdf" width="100%" height="100%">
