...
if(isset($_POST['upload_form_submit'])){
        ...
        try {
            ...
            if (($_FILES["file"]["type"] == "application/pdf")) {
                if ($_FILES["file"]["error"] > 0) {
                    ...
                    if (file_exists("files/forms/" . $_FILES["file"]["name"])) {
...
<form action='' method='post' enctype="multipart/form-data">
    ...
    <p><input class="upload" name='upload_form_submit' type='submit' value='Submit'></p>
