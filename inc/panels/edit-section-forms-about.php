...
if(isset($_POST['edit_section_forms_about_submit'])){
...
//check for any errors
    ...
    try {
        ...
        $stmt->execute(array(':section_ID' => 6));
        $row = $stmt->fetch(); 
...
<form action='' method='post'>
    ...
    <p><input class="submit-button" name='edit_section_forms_about_submit' type='submit' value='Submit'></p>
