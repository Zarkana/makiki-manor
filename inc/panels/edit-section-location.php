...
if(isset($_POST['edit_section_location_submit'])){
...
//check for any errors
    ...
    try {
        ...
        $stmt->execute(array(':section_ID' => 2));
        $row = $stmt->fetch(); 
...
<form action='' method='post'>
    ...
    <p><input class="submit-button" name='edit_section_location_submit' type='submit' value='Submit'></p>
