...
<form id="admin-login-form" action="" method="post">
    ...
    <p><input class="submit-button" id="login-submit"  name="admin-login-submit" class="submit-button login-input" id="" class="submit-button" type="submit" value="Log In"></p>
    <a href="#" onclick="return false;" class="ignore-target" href=""><p id="forgot-password">Forgot Password?</p></a>
</form>

<form id="admin-reset-password-form"action="" method="post">
    <input name="forward" type="hidden" value="<?php echo($_GET['forward']); ?>">
    <p><input placeholder="Email" id="reset-email" name="email" class="login-input" type="text"></p>
    <p><input class="submit-button" id="reset-submit"  name="admin-reset-submit" class="submit-button login-input" id="" class="submit-button" type="submit" value="Send Email"></p>
