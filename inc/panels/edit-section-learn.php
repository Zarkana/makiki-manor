...
if(isset($_POST['edit_section_learn_submit'])){
...
//check for any errors
    ...
    try {
        ...
        $stmt->execute(array(':section_ID' => 1));
        $row = $stmt->fetch(); 
...
<form action='' method='post'>
    ...
    <p><input class="submit-button" type='submit' name='edit_section_learn_submit' value='Submit'></p>
