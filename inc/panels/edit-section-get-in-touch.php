...
if(isset($_POST['edit_section_get_in_touch'])){
...
//check for any errors
    ...
    try {
        ...
        $stmt = $db->prepare('SELECT sectionID, sectionHeader, sectionContent FROM sections WHERE section_ID = :section_ID') ;
...
<form action='' method='post'>
    <input name='section_ID' type='hidden' value='<?php echo $row['sectionID'];?>'>
    ...
    <p><input class="submit-button" name='edit_section_get_in_touch' type='submit' value='Submit'></p>
